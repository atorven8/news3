...
export class News extends Component {
  ...
  async handleNext() {
    ...
    let url = `https://newsapi.org/v2/top-headlines?country=${
      this.props.country
    }&category=${this.props.category}&apiKey=fdce4ea936e34e3eb2b31de6cfc22b89&page=${
      this.state.pg + 1
  ...
  async componentDidMount() {
    window.scrollTo(0, 0);
    const url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=fdce4ea936e34e3eb2b31de6cfc22b89&page=1&pageSize=${this.props.pageSize}`;
    this.setState({ loading: true });
    let data = await fetch(url);
    let parsedData = await data.json();
